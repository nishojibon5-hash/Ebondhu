...
export default function CashOut() {
  ...
  const [wallets, setWallets] =
    useState<Record<WalletKey, WalletConfig>>(DEFAULT_WALLETS);
  ...
  useEffect(() => {
    try {
      ...
      if (cfg && typeof cfg === "object")
        setWallets({ ...DEFAULT_WALLETS, ...cfg });
    } catch {}
  }, []);

  const availableWallets = (Object.keys(wallets) as WalletKey[]).filter(
    (k) => wallets[k].enabled,
  );
  ...
  const validateStep1 = () => {
    ...
    if (!number || number.length !== 11 || !number.startsWith("01"))
      errs.number = "সঠিক ওয়ালেট নম্বর দিন";
    setErrors(errs);
        ...
        <div className="p-4">
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 text-center">
            ...
            <p className="text-gray-600 mb-6">
              এডমিন যাচাই করে ম্যানুয়ালি অর্থ প্রেরণ করবেন
            </p>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-bkash-600">
                ৳{balance.toFixed(2)}
              </p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              {availableWallets.map((w) => (
                <button
                  key={w}
                  onClick={() => setWallet(w)}
                  className={`p-3 rounded-xl border ${wallet === w ? "border-bkash-500 bg-pink-50" : "border-gray-200"}`}
                >
                  <div className="flex flex-col items-center text-sm">
                    <Wallet className="h-5 w-5 mb-1 text-bkash-500" />
                    <span>
                      {w === "bkash" ? "বিকাশ" : w === "nagad" ? "নগদ" : "রকেট"}
                    </span>
                  </div>
                </button>
              ))}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="0.00"
                step="0.01"
                className={`w-full pl-10 pr-3 py-3 border rounded-xl focus:ring-2 focus:ring-bkash-500 focus:border-transparent ${errors.amount ? "border-red-500" : "border-gray-300"}`}
              />
            </div>
            {errors.amount && (
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                maxLength={11}
                className={`w-full pl-10 pr-3 py-3 border rounded-xl focus:ring-2 focus:ring-bkash-500 focus:border-transparent ${errors.number ? "border-red-500" : "border-gray-300"}`}
              />
              <button
                type="button"
                onClick={() => {
                ...
                className="absolute right-2 top-2 text-gray-500 hover:text-gray-700 flex items-center gap-1 text-sm"
              >
          ...
          <div className="bg-blue-50 rounded-xl p-3 border border-blue-200">
            <div className="flex items-start gap-2 text-blue-900 text-sm">
              ...
              <p>
                রিকুয়েস্ট সাবমিট করলে এডমিন যাচাই করে আপনার নম্বরে টাকা
                পাঠাবেন। অনুমোদনের পর আপনার ব্যালেন্স থেকে টাকা কাটা হবে এবং
                এডমিন ওয়ালেটে যোগ হবে।
              </p>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full bg-bkash-600 hover:bg-bkash-700 text-white py-3 rounded-xl font-semibold"
          >
