...
export default function AddMoney() {
  ...
  const validateStep2 = () => {
    ...
    if (selectedMethod?.type === 'mfs' && (!accountNumber || accountNumber.length !== 11)) {
      ...
      <div className="pb-20 min-h-screen bg-gray-50">
        ...
        <div className="p-4">
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 text-center">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-2">টাকা সফলভাবে যোগ হয়েছে!</h2>
            <p className="text-gray-600 mb-6">আপনার ওয়ালেটে টাকা যোগ সম্পন্ন হয়েছে</p>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    ৳{selectedMethod ? calculateFee(selectedMethod, parseFloat(amount)).toFixed(2) : '0'}
                  </span>
                </div>
        ...
        <div className="p-4">
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div className="text-center mb-6">
              <div className={`w-16 h-16 ${selectedMethod?.color} rounded-full flex items-center justify-center mx-auto mb-4 text-white text-2xl`}>
                {selectedMethod?.logo}
              </div>
              <h2 className="text-xl font-bold text-gray-900 mb-2">{selectedMethod?.name} পেমেন্ট</h2>
              <p className="text-gray-600">���িচের QR কোড স্ক্যান করুন অথবা লিংকে যান</p>
            </div>
    ...
    <div className="pb-20 min-h-screen bg-gray-50">
      ...
      <div className="p-4">
        ...
        {currentStep === 1 && (
          <div className="space-y-6">
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
              <h2 className="text-lg font-bold text-gray-900 mb-4">পেমেন্ট পদ্ধতি নির্বাচন করুন</h2>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  {paymentMethods.filter(m => m.type === 'mfs').map((method) => (
                    <button
                      key={method.id}
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-500">
                            ফি: ৳{method.fee} • সীমা: ��{method.minAmount} - ৳{method.maxAmount.toLocaleString()}
                          </p>
                        </div>
                        {selectedMethod?.id === method.id && (
        ...
        {currentStep === 2 && selectedMethod && (
          <div className="space-y-6">
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
              <h2 className="text-lg font-bold text-gray-900 mb-4">পরিমাণ ও বিবরণ</h2>
              
              {/* Selected Method Info */}
              <div className="bg-blue-50 rounded-xl p-3 mb-4 border border-blue-200">
                <div className="flex items-center space-x-3">
                  <div className={`w-8 h-8 ${selectedMethod.color} rounded-full flex items-center justify-center text-white text-sm`}>
                    {selectedMethod.logo}
                  </div>
                  <div>
                    <p className="font-medium text-blue-900">{selectedMethod.name}</p>
              ...
              <div className="mb-4">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  সীমা: ৳{selectedMethod.minAmount} - ৳{selectedMethod.maxAmount.toLocaleString()}
                </p>
              </div>
                ...
                <div className="bg-yellow-50 rounded-xl p-4 border border-yellow-200">
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>৳{calculateFee(selectedMethod, parseFloat(amount)).toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between font-bold border-t border-yellow-300 pt-2">
                      <span>মোট পেমেন্ট:</span>
                      <span>৳{(parseFloat(amount) + calculateFee(selectedMethod, parseFloat(amount))).toFixed(2)}</span>
                    </div>
                  </div>
                </div>
              )}
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between font-bold border-t border-gray-200 pt-2">
                    ...
                    <span className="text-bkash-500">
                      ৳{selectedMethod ? (parseFloat(amount) + calculateFee(selectedMethod, parseFloat(amount))).toFixed(2) : amount}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 rounded-xl p-3 border border-blue-200">
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-sm text-blue-800">
                    নিশ্চিত করার পর আপনাকে {selectedMethod?.name} পেমেন্ট পেজে নিয়ে যাওয়া হবে।
                  </p>
                </div>
              </div>
            </div>
