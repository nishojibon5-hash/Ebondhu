...
export default function MobileRecharge() {
  ...
  const validateStep2 = () => {
    ...
    if (!amount || rechargeAmount <= 0)
      newErrors.amount = "রিচার্জের পরিমাণ নির্ব��চন করুন";
    else if (rechargeAmount < 10)
      newErrors.amount = "ন্যূনতম ১০ টাকা রিচার্জ করতে পারবেন";
    else if (rechargeAmount > 5000)
      newErrors.amount = "সর্বোচ্চ ৫,০০০ টাকা রিচার্জ করতে পারবেন";
    else if (rechargeAmount > currentBalance)
      newErrors.amount = "অপর্যাপ্ত ব্যালেন্স";
        ...
        <div className="p-4">
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 text-center">
            ...
            <p className="text-gray-600 mb-6">
              আপনার মোবাইল রিচার্জ সম্পন্ন হয়েছে
            </p>
                ...
                {operators.map((operator) => (
                  ...
                  >
                    <div className="text-center">
                      <div
                        className={`w-12 h-12 ${operator.color} rounded-full flex items-center justify-center mx-auto mb-2 text-white text-xl`}
                      >
                        {operator.logo}
                      </div>
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
              ...
              <div className="bg-blue-50 rounded-xl p-3 mb-4 border border-blue-200">
                <div className="flex items-center space-x-3">
                  <div
                    className={`w-8 h-8 ${selectedOperator.color} rounded-full flex items-center justify-center text-white text-sm`}
                  >
                ...
                {getOperatorOffers(selectedOperator.id).map((offer, index) => (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        <p className="font-bold text-bkash-500 text-lg">
                          ৳{offer.amount}
                        </p>
              ...
              <div className="bg-red-50 rounded-xl p-3 border border-red-200">
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-sm text-red-800">
                    রিচার্জ নিশ্চিত করার পর টাকা ফেরত পাওয়া যাবে না। নম্বর ও
                    পরিমাণ যাচাই করুন।
                  </p>
                </div>
              </div>
